...
public class YearTemperatureStatsImpl implements YearTemperatureStats {
  ...
  private Map<Month, List<DayTemperatureInfo>> temperatureInfo = new HashMap<>();
  ...
  public void updateStats(DayTemperatureInfo info) {
    ...
    if(Objects.isNull(dayTemperatureInfos)){
      dayTemperatureInfos = new ArrayList<>(Collections.nCopies(60, null));
    }
  ...
  private static class MonthStats {
    ...
    private int days = 0;
    private Map<DayTemperatureInfo, Integer> queue = new HashMap();
    ...
    public void updateMonthStats(DayTemperatureInfo averageTemperature) {
      ...
      queue.put(averageTemperature, counter++);
    }
    ...
    public int compareEquals(DayTemperatureInfo d1, DayTemperatureInfo d2){
      return queue.get(d1) - queue.get(d2);
    }
  }
}
